...
function leer_categorias($color){
	
if( is_category('Nuevo Post de Platos')){
	$color='<span class="col s12 #e53935 red darken-1"><h4><i class="material-icons">insert_chart</i>Nuevo Post de Platos</h4></span>';
	return $color;
}

else if( is_category('Nuevo Post de Ocasiones')){
	$color='<span class="col s12 #42a5f5 blue lighten-1"><h4><i class="material-icons">call_to_action</i>Nuevo Post de Ocasiones</h4></span>';
	return $color;
}
	
else if( is_category('Nuevo Post de Regiones')){
	$color='<span class="col s12 #76ff03 light-green accent-3"><h4><i class="material-icons">call_to_action</i>Nuevo Post de Regiones</h4></span>';
	return $color;
...
add_filter('get_the_archive_title','leer_categorias');
